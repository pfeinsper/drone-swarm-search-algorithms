...
from ..training_utils import config_log, log_episode_stats, get_random_speed_vector, init_results_writer
...
class ReinforceAgentsIL:
    ...
    def train(self, results_folder):
        ...
        writer, results_file = init_results_writer(results_folder)
        ...
        for i in range(self.episodes + 1):
            ...
            while not done:
                ...
                observations, reward_dict, term, trunc, _ = self.env.step(episode_actions)
    ...
    def save_neural_networks(self, path):
        ...
        for index in range(self.num_agents):
            torch.save(
                ...
                f"{path}nn_drone{index}_reinforce_il.pt",
            )
